    ...
    <Zoom left>
      <section className="p-20 px-12 min-h-screen md:h-screen">
        <div className="flex justify-center items-center">
          <h1   style={{fontSize: 20}} className="tracking-[.7rem] uppercase font-light text-2xl md:text-3xl text-center">
          The companies we work with are committed to creating a diverse workforce           </h1>
        </div>
